  ...
  const experiences = [
    {
      ...
      description: "Contributing to the architecture design and backend planning of the Akij Air system using Java-based microservices and PostgreSQL. Engaged in exploratory planning and system modularization. Previously led the TrackForce project, developing REST APIs and SQL reports. Assisted in refactoring legacy .NET modules into scalable Java services.",
    ...
    },
    {
      ...
      description: "Developed scalable full-stack solutions using Spring Boot and React. Optimized Oracle database structures and integrated OAuth2-based security. Contributed to Customs Bond Management System for NBR, implementing legal and declaration modules and integrating BGMEA/BKMEA data systems.",
    ...
    },
    {
      ...
      description: "Worked on enterprise backend solutions using Spring Boot and JavaEE. Led backend development for Rakuten Echiba and built secure APIs using SOAP and REST. Managed Oracle DB operations and created API specifications and UML documentation for scalable enterprise solutions.",
    ...
    },
    {
      ...
      description: "Assisted in teaching core computer science courses such as OOP and Data Structures. Conducted labs, prepared assignments, and mentored students. Delivered lectures independently under faculty guidance and supported academic activities within the department.",
