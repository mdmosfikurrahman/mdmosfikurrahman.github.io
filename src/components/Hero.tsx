...
import { Github, Linkedin, GraduationCap, Download, Mail, MapPin, Phone, Briefcase, BookOpen } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto text-center">
                <div className="mb-8">
                    <div className="w-48 h-48 mx-auto mb-8 rounded-full overflow-hidden shadow-lg">
                        <img src="/assets/IMG_9615.JPG" alt="Md. Mosfikur Rahman" className="w-full h-full object-cover" />
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                    <p className="text-lg text-gray-700 leading-relaxed">
                        I design and build scalable backend systems (<strong>Java · Spring Boot · PostgreSQL</strong>) and pursue research at the intersection of <strong>AI/ML</strong> and real-world systems. I’m actively open to <strong>MS/PhD opportunities</strong> as well as <strong>industry roles</strong>.
                    </p>
                </div>
