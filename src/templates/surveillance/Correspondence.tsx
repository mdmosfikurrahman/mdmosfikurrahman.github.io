      ...
      <div className="shell relative py-20 md:py-28">
        <div className="grid grid-cols-12 gap-y-10 md:gap-x-10">
          ...
          <div className="col-span-12 md:col-span-5">
            <p className="sig">RECORD 05 / OPEN CHANNEL</p>
            <h2 className="font-display text-2xl md:text-[2rem] lg:text-[2.25rem] leading-[1.1] tracking-[-0.02em] mt-3 text-balance uppercase"
                style={{ color: "hsl(var(--ink))" }}>
              <span style={{ color: "hsl(var(--accent))" }}>&gt; </span>
              IF SOMETHING HERE IS USEFUL,{" "}
              <span className="opacity-60 normal-case">or you wish to build something together</span>
              ,{" "}
              <a
                className="no-underline hover:opacity-80 transition-opacity whitespace-nowrap"
                style={{ color: "hsl(var(--accent))" }}
                href={`mailto:${profile.email}`}
              >
                OPEN CHANNEL<span className="caret" />
              </a>
            </h2>

            <p className="mt-6 text-[14px] leading-[1.7] max-w-[44ch]"
            ...
            <div className="mt-8 pt-5 border-t rule">
              <p className="mg-label mb-2">[ IN PERSON / GPS LOCK ]</p>
          ...
          <div className="col-span-12 md:col-span-7 md:pl-6 lg:pl-10 md:border-l rule-soft">
            ...
            <div className="mt-8 flex items-end justify-between gap-4">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em]"
                 style={{ color: "hsl(var(--muted))" }}>
                <span style={{ color: "hsl(var(--accent))" }}>&gt; </span>END_OF_TRANSMISSION
              </p>
              <p
                aria-hidden
                className="font-mono text-lg md:text-2xl leading-none select-none tracking-[0.18em]"
                style={{ color: "hsl(var(--accent))" }}
              >
                [M.M.R.]
              </p>
