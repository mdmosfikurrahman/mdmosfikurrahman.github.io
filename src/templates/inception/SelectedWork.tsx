  ...
  return (
    <section id="work" className="border-b rule-soft">
      <div className="shell py-16 md:py-20">
        <div className="mg">
          <div>
            <p className="sig">Level 02 · Plans</p>
            <h2 className="mt-3 font-display text-2xl md:text-3xl tracking-[-0.02em]"
                style={{ color: "hsl(var(--ink))" }}>
              Selected plates.
            </h2>
            <p className="mt-4 text-[14px] leading-relaxed max-w-[24ch]"
               style={{ color: "hsl(var(--muted))" }}>
              Architectures worth filing first.
            </p>
            <Link to="/experience" className="a-arrow text-sm mt-5 inline-flex items-center gap-1.5 font-mono">
              Full set <span aria-hidden>→</span>
            </Link>
          </div>
              ...
              <li key={p.name}
                ...
                <div className="min-w-0">
                  ...
                  <h3 className="font-display text-xl md:text-2xl leading-tight tracking-tight flex items-baseline flex-wrap gap-x-3 gap-y-1">
                    ...
                    {p.flagship && (
                      <span className="font-mono text-[9px] uppercase tracking-[0.22em] px-1.5 py-0.5 leading-none translate-y-[-2px]"
                            style={{
                  ...
                  <div className="mt-3 h-px bp-hair max-w-[8rem]" aria-hidden />
                ...
                <span className="hidden md:inline font-mono text-[11px] uppercase tracking-[0.16em] pt-[3px]"
